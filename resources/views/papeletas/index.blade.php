    ...
    <x-slot name="header">
        <div class="flex justify-between items-center flex-wrap gap-3">
            ...
            <div class="flex items-center gap-2">
                {{-- La exportación cruda (Excel/PDF por fila) que vivía aquí se
                quitó: quedaba duplicada con /reportes, que ya exporta a Excel
                con los mismos filtros más datos agregados (ver
                ReporteController::exportar). RRHH la encuentra ahí. --}}
