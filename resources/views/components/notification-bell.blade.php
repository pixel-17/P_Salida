...
<div x-data="notificacionesBell()" x-init="init()" class="relative">
    <button @click="abierto = !abierto" class="relative p-2 rounded-full glass hover:bg-white/70 transition-all duration-200" aria-label="Notificaciones" :aria-expanded="abierto.toString()">
