<x-app-layout>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4 stagger">
        ...
        <div class="glass-panel p-5 animate-fade-in-up">
            ...
            @if($rankingHorasFuera->isNotEmpty())
                ...
                <p class="text-xs text-gray-500 mt-1">
                    {{ $topHoras['area'] ?? 'Sin área' }}
                    ·
                    Jefe: {{ $topHoras['jefe'] ?? 'Sin jefe' }}
                </p>
    ...
    <div class="glass-panel p-5 mb-4 animate-fade-in-up">
        ...
        <p class="text-xs text-gray-400 mb-4">
            Solo incluye salidas con marcación de salida y retorno registradas.
        </p>
            ...
            <div>
                ...
                <select
                    ...
                    @foreach($estados as $estado)
                        ...
                        <option
                            value="{{ $estado->id }}"
                            @if(($filtrosDetalle['estado_id'] ?? null) == $estado->id)
                                selected
                            @endif>
            ...
            <div>
                ...
                <select
                    ...
                    @foreach($areas as $area)
                        ...
                        <option
                            value="{{ $area->id }}"
                            @if(($filtrosDetalle['area_id'] ?? null) == $area->id)
                                selected
                            @endif>
                    ...
                    @forelse($detalleSalidas as $papeleta)
                        ...
                        <tr class="border-b border-white/40 last:border-0">
                            ...
                            <td class="py-2.5 pr-0 text-right">
                                ...
                                <a
                                    href="{{ route('papeletas.show', $papeleta) }}"
        ...
        <div class="md:hidden space-y-3">
            ...
            @forelse($detalleSalidas as $papeleta)
                ...
                <div
                    ...
                    <a
                        href="{{ route('papeletas.show', $papeleta) }}"
                        class="btn-secondary !py-1.5 text-xs mt-3 inline-block">
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                if (trabajadores.length) {
                    ...
                    new Chart(
                        document.getElementById('chartTrabajadores'),
                        {
                            type: 'bar',
                ...
                if (areas.length) {
                    ...
                    new Chart(
                        document.getElementById('chartAreas'),
                        {
                            type: 'bar',
